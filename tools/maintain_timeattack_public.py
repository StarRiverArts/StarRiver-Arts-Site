...
DESCRIPTIONS = {
    "catalog.html": "Racing Hub 的賽道世界、車手、車輛、車隊、活動與紀錄資料索引。",
    "event.html": "Racing Hub 活動詳情模板；請由活動列表開啟指定活動。",
    "events.html": "Racing Hub 的活動公告、賽事規則與人工確認結果。",
    "index.html": "Racing Hub 賽事中心，提供 VRChat 賽道世界、車手、車輛、車隊、活動與 Time Attack 紀錄。",
    ...
    "track.html": "Racing Hub 單一賽道世界、世界內路線與 Time Attack 紀錄詳情。",
    "tracks.html": "Racing Hub 賽道世界、世界內路線與 Time Attack 紀錄索引。",
    ...
    payload["sections"] = [
        {
            ...
            "body_zh": "VRRCTW 是以 VRChat 賽車、夜跑、計時挑戰與社群活動為核心的玩家社群；Racing Hub 整理俱樂部與更廣泛 VRChat 賽車生態的賽道世界、車手、車輛、活動與計時資料。",
            "body_en": "VRRCTW is a player community centered on VRChat racing, night runs, time attacks, and club events. Racing Hub organizes public track worlds, racers, vehicles, events, and timing data across the club and the wider VRChat racing ecosystem.",
            "items_zh": ["俱樂部活動與賽事", "賽道世界、車手、車隊與車輛資料", "公開排行榜與活動結果"],
            "items_en": ["Club sessions and races", "Track worlds, racers, teams, and vehicles", "Public leaderboards and event results"],
        },
        {
            "label_zh": "加入與投稿",
